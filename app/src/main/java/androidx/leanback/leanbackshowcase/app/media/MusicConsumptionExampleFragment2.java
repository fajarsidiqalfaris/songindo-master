...
import androidx.leanback.leanbackshowcase.app.wizard.models.Song;
import androidx.leanback.leanbackshowcase.app.wizard.models.SongList;
 ...
 */
public class MusicConsumptionExampleFragment2 extends PlaybackFragment implements
        BaseOnItemViewClickedListener {

    private static final String TAG = "MusicConsumptionExampleFragment2";
    ...
    @Override public void onCreate(Bundle savedInstanceState) {
        ...
        String json = Utils.inputStreamToString(
                getResources().openRawResource(R.raw.lagu_daerah));
    ...
    public MusicConsumptionExampleFragment2() {
        super();
    }
